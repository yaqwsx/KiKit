...
def test_biteBoundary():
    ...
    t1 = biteBoundary(l1, (1, 0.5), (0.5, 1), 0.01)
    assert t1 == LineString([(1, 0.5), (1, 1), (0.5, 1)])

    t2 = biteBoundary(l1, (0, 0.5), (0.5, 0), 0.1)
    assert t2 is None

    t3 = biteBoundary(l2, (0, 0.5), (0.5, 0), 0.1)
    assert t3 == LineString([(0, 0.5), (0, 0), (0.5, 0)])

    t4 = biteBoundary(l3, (0, 0.5), (0.5, 0), 0.1)
    assert t4 == LineString([(0, 0.5), (0, 0), (0.5, 0)])

    t5 = biteBoundary(l1, (1, 0.25), (1, 0.75), 0.1)
